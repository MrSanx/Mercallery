...
public class VerObra extends AppCompatActivity {

    private ListView listObra;
    AdaptadorObra adaptadorObra;
    public static ArrayList<Obra> obras= new ArrayList<>();
    String url= "https://galeriabd.000webhostapp.com/crud/mostrarObras.php";
    Obra Obr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listObra= findViewById(R.id.listObra);
        ...
        listObra.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                CharSequence[] dialogItem= {"Ver Datos", "Editar Datos","Eliminar"};
                ...
                builder.setItems(dialogItem, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        switch (i){
                            case 0:
                                startActivity(new Intent(getApplicationContext(),DetallesObra.class).putExtra("position",position));
                                break;
                            case 1:
                                startActivity(new Intent(getApplicationContext(),EditarObra.class).putExtra("position",position));
                                break;
                            case 2:
                                startActivity(new Intent(getApplicationContext(),EliminarObra.class).putExtra("position",position));
                                break;
    ...
    public void muestraObras() {
        ...
        StringRequest request= new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(VerObra.this, error.getMessage(),Toast.LENGTH_SHORT).show();
            }
        });
