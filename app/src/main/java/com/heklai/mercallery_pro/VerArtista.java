...
public class VerArtista extends AppCompatActivity {

    private ListView list;
    AdaptadorPersona adaptadorPersona;
    public static ArrayList<Persona> personas= new ArrayList<>();
    String url= "https://galeriabd.000webhostapp.com/crud/mostrarArtista.php";
    Persona person;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ver_artista);

        list= findViewById(R.id.ListViewArtista);
    ...
    public void muestraPersonas() {
        ...
        StringRequest request= new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(VerArtista.this, error.getMessage(),Toast.LENGTH_SHORT).show();
            }
        });
